...
export const protocolsTable = pgTable("protocols", {
  ...
  // Provenance: "curated" = clinical reference content with literature citations,
  // "ai-generated" = personalised protocol generated by the three-lens engine
  // for one specific patient's biomarker profile. Patient-specific protocols
  // also set patientId so they only appear in that patient's library.
