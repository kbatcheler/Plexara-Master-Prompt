...
const BIOMARKERS: BiomarkerSeed[] = [
...

  {
    ...
    clinicalSignificance: "Conventional medicine treats TSH above 4.0 (or 10.0 in some guidelines) as hypothyroid. Functional medicine recognises that TSH above 2.0-2.5, especially with symptoms (fatigue, cold intolerance, hair loss, constipation), indicates suboptimal thyroid function long before it meets the conventional cutoff. TSH must be interpreted alongside Free T3, Free T4, Reverse T3, and thyroid antibodies — TSH alone is insufficient for thyroid assessment. Selenium, zinc, iron, iodine, and cortisol all influence the TSH→T4→T3 axis (Wartofsky L and Dickey RA, JCEM 2005;90(9):5483-8; IFM thyroid module).",
    functionalMedicineNote: "Functional optimal 0.5-2.0 mIU/L. TSH 2.5-4.0 with symptoms warrants investigation even though 'normal' by conventional reference ranges. Always interpret with Free T3, Free T4, Reverse T3, and TPO antibodies — never in isolation.",
  },
  {
...

  {
    ...
    optimalRangeLow: null,
    optimalRangeHigh: "0.5",
    ageAdjusted: false,
    sexAdjusted: false,
    description: "High-sensitivity C-Reactive Protein; systemic inflammation marker.",
    clinicalSignificance: "Conventional medicine considers hs-CRP below 3.0 mg/L as 'normal.' Functional medicine targets below 0.5 as optimal, with below 1.0 as acceptable. CRP between 1-3 indicates chronic low-grade inflammation — the underlying driver of cardiovascular disease, metabolic dysfunction, neurodegeneration, and accelerated aging. Don't accept 'normal' at face value; investigate root causes: gut permeability, food sensitivities, chronic infection (dental, sinus, gut), poor sleep, overtraining, visceral adiposity, and environmental toxins. Each 1 mg/L increase is associated with ~15% higher cardiovascular event risk (Ridker PM et al., NEJM 2002;347(20):1557-65).",
    functionalMedicineNote: "Functional target <0.5 mg/L. Between 1-3 is chronic low-grade inflammation, not 'normal' — trace the root cause (gut, infection, sleep, training load, food sensitivities) rather than reassuring the patient.",
  },
  {
    biomarkerName: "ESR",
    category: "Inflammatory",
  ...
  },
  {
    ...
    clinicalSignificance: "Conventional medicine considers homocysteine below 15 as normal. Functional medicine targets below 7-8 as optimal. Elevated homocysteine is an independent cardiovascular risk factor, a marker of impaired methylation, and is associated with cognitive decline, bone fracture risk, and pregnancy complications. It responds well to methyl-B vitamins (methylfolate, methylcobalamin, P-5-P) and TMG — the FORM matters: methylated cofactors, not synthetic folic acid or cyanocobalamin, especially in the presence of MTHFR variants. Trace upstream: B12, folate, B6, betaine, and MTHFR/MTRR genetics (Homocysteine Studies Collaboration, BMJ 2002;325(7374):1202).",
    functionalMedicineNote: "Functional target <7 umol/L. Responds to methyl-donor B vitamins — form matters (methylfolate, not folic acid; methylcobalamin, not cyanocobalamin). Check MTHFR genotype if persistently elevated despite supplementation.",
  },
  {
    ...
    clinicalSignificance: "Ferritin is BOTH an iron storage marker AND an acute-phase inflammatory marker — always co-interpret with hs-CRP. Conventional medicine flags ferritin below 12 as deficient, but this is the threshold for iron-deficiency anaemia, not the threshold for functional deficiency. Symptoms of iron depletion (fatigue, hair loss, cold intolerance, exercise intolerance, restless legs) commonly begin at ferritin below 50, especially in menstruating women and endurance athletes. Conversely, ferritin above 200 in a non-inflammatory context (CRP normal) may indicate iron overload — check transferrin saturation and consider hereditary haemochromatosis (HFE genotype). Form of supplementation matters: iron bisglycinate is far better tolerated than ferrous sulfate (WHO 2020; Koperdanova M et al., BMJ 2015).",
    functionalMedicineNote: "Functional deficiency begins below 50 ng/mL, not below 12. Always co-interpret with hs-CRP — inflammation can mask true iron status. If supplementing, prefer iron bisglycinate over ferrous sulfate for tolerability.",
  },
...

  {
    ...
    ageAdjusted: false,
    sexAdjusted: false,
    description: "25-hydroxyvitamin D; best measure of vitamin D status. (40-80 ng/mL ≈ 100-200 nmol/L.)",
    clinicalSignificance: "Vitamin D is a steroid hormone precursor critical for immune regulation, bone metabolism, cardiovascular health, hormonal synthesis, and gene expression — not just a vitamin. The conventional 'upper safety limit' of 50 ng/mL (125 nmol/L; Endocrine Society) is conservative and increasingly challenged by research showing benefits at higher levels without toxicity when co-supplemented with vitamin K2 (MK-7, 100-200mcg/day) and adequate magnesium. The actual concern at high vitamin D is hypercalcaemia, which is mediated by inadequate K2 (which directs calcium to bone) and inadequate Mg (required for vitamin D metabolism). When K2 and Mg are co-supplemented and serum calcium and PTH are normal, the functional optimal range extends to 80 ng/mL (200 nmol/L). Clinical deficiency below ~12 ng/mL (30 nmol/L) is associated with osteoporosis, autoimmune disease, cardiovascular disease, cancer, and all-cause mortality (Holick MF, NEJM 2007;357(3):266-81; Attia P, Outlive, 2023).",
    functionalMedicineNote: "No well-established toxicity threshold for D3 when K2 (MK-7) and magnesium are co-supplemented and calcium is monitored. Functional optimal 40-80 ng/mL (≈100-200 nmol/L). The Endocrine Society 50 ng/mL (125 nmol/L) ceiling is a conservative position that many functional medicine practitioners and longevity researchers consider outdated. Always specify D3 (cholecalciferol), not D2.",
  },
  {
    ...
    clinicalSignificance: "Conventional medicine flags B12 deficiency below 200 pg/mL — the threshold for macrocytic anaemia and (often irreversible) neuropathy. Functional medicine recognises that 'serum-adequate' B12 (200-500 pg/mL) frequently masks tissue-level functional deficiency, especially in vegetarians/vegans, the elderly, PPI/metformin users, and those with H. pylori or atrophic gastritis. Confirm with methylmalonic acid (MMA — most sensitive functional marker) and homocysteine. Form of supplementation matters: methylcobalamin and adenosylcobalamin are bioactive; cyanocobalamin requires methylation (problematic with MTHFR variants). Always co-interpret with folate (high folate can mask B12-driven anaemia while neuropathy progresses) (Stabler SP, NEJM 2013;368(2):149-60).",
    functionalMedicineNote: "Serum B12 above 200-300 pg/mL is 'adequate' by conventional standards but functional insufficiency is possible up to ~500 pg/mL. Confirm with MMA and homocysteine. Prefer methylcobalamin/adenosylcobalamin over cyanocobalamin — form matters, especially with MTHFR variants. Always co-test folate to avoid masking effects.",
  },
  {
  ...
  },
  {
    ...
    clinicalSignificance: "Serum magnesium is a poor marker — it represents <1% of total body magnesium and is tightly regulated at the expense of intracellular stores. RBC magnesium is a better (though still imperfect) marker; functional medicine targets the upper half of the range (5.5-6.5). Magnesium is a cofactor in 300+ enzymatic reactions including ATP production, DNA repair, neurotransmitter synthesis, and vitamin D metabolism. Deficiency is endemic in modern diets (depleted soils, processed food, gut malabsorption, alcohol, PPIs, diuretics) and contributes to insulin resistance, hypertension, arrhythmias, muscle cramps, migraines, and anxiety. Form matters: magnesium glycinate, malate, or threonate are well-absorbed and well-tolerated; magnesium oxide is poorly absorbed and acts as a laxative. Serum magnesium above the reference range is almost always supplementation-related and typically benign — reduce the dose and retest rather than investigating pathology (DiNicolantonio JJ et al., Open Heart 2018;5(1):e000668).",
    functionalMedicineNote: "Serum Mg is a poor marker (<1% of body stores). RBC Mg is preferred but still imperfect — target the upper half (5.5-6.5 mg/dL). Form matters: glycinate/malate/threonate over oxide. Above-range serum Mg is almost always supplementation, not pathology — reduce dose, don't investigate.",
  },
  {
    biomarkerName: "Zinc",
    category: "Vitamins",
  ...
  },
  {
    ...
    clinicalRangeHigh: "150",
    optimalRangeLow: "100",
    optimalRangeHigh: "170",
    ageAdjusted: false,
    sexAdjusted: false,
    description: "Essential trace mineral; thyroid function, antioxidant defence, immune support.",
    clinicalSignificance: "The conventional upper limit of 150 ug/L is conservative. Research on selenoprotein P saturation suggests the optimal range for thyroid function (T4→T3 conversion via deiodinase enzymes), immune health, and antioxidant capacity is 100-170 ug/L. True selenium toxicity (selenosis) typically requires sustained levels above 400 ug/L, with hair/nail brittleness as the earliest sign. Supplementation should not exceed 200-400 mcg/day, and Brazil nuts (1-3 daily) are a preferred food source. Always interpret alongside thyroid function, since selenium deficiency impairs T4→T3 conversion and worsens autoimmune thyroid disease — supplementation of 200mcg/day reduced TPO antibodies by ~40% in Hashimoto's patients (Toulis KA et al., Thyroid 2010;20(10):1163-73).",
    functionalMedicineNote: "Selenoprotein P saturation research supports 100-170 ug/L as functional optimal. True toxicity requires sustained >400 ug/L. Always co-interpret with thyroid panel — selenium is a cofactor for T4→T3 conversion. Brazil nuts (1-3/day) are an excellent food source.",
  },
...

  {
    ...
    clinicalSignificance: "Fasting insulin is the single most important metabolic biomarker that conventional medicine largely ignores — by the time fasting glucose is elevated, insulin resistance has been present for years to decades (Kraft JR, Diabetes Epidemic & You, 2008). Insulin below 5 mU/L indicates excellent insulin sensitivity. Above 8 indicates early resistance. Above 12 indicates significant metabolic dysfunction even when glucose is 'normal.' HOMA-IR (fasting insulin × fasting glucose / 405) below 1.0 is optimal. Always interpret alongside HbA1c, fasting glucose, triglyceride:HDL ratio, and waist circumference — and consider time-restricted eating, resistance training, and reduction of refined carbohydrates as first-line interventions before pharmacology (Attia P, Outlive, 2023).",
    functionalMedicineNote: "The most underutilised metabolic marker in conventional practice. Functional target <5 mU/L. Most GPs don't test it — flag the gap. Pair with HOMA-IR (target <1.0). Lifestyle (time-restricted eating, resistance training, refined-carb reduction) is first-line, not pharmacology.",
  },
  {
    biomarkerName: "HbA1c",
    category: "Metabolic Health",
    ...
    ageAdjusted: true,
    sexAdjusted: false,
    description: "Glycated Hemoglobin; 90-day average blood sugar indicator. (5.0% ≈ 31 mmol/mol; 6.0% ≈ 42 mmol/mol.)",
    clinicalSignificance: "Conventional medicine considers HbA1c below 6.0% (42 mmol/mol) as non-diabetic and below 5.7% as 'normal.' Functional medicine targets below 5.0% (31 mmol/mol) for optimal metabolic health. HbA1c between 5.0-5.4% is a grey zone where insulin resistance is often already present (cross-check fasting insulin and HOMA-IR — they will frequently be elevated despite 'normal' HbA1c). The longevity medicine community considers glycaemic variability and post-prandial glucose excursions (best assessed via continuous glucose monitoring) as equally or more important than the HbA1c average alone. Each 1% increase above 5.0% is associated with ~28% higher all-cause mortality (Selvin E et al., NEJM 2010;362(9):800-11).",
    functionalMedicineNote: "Functional target <5.0% (≈31 mmol/mol). HbA1c between 5.0-5.4% often masks insulin resistance already in motion — check fasting insulin and HOMA-IR. Consider CGM for glycaemic variability, which matters as much as the average.",
  },
  {
